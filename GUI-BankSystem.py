...
def Cr_Amt(accnt,name):
	...
	l_title=tk.Message(creditwn,text="  Shivani Ka Bank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="#C21807",justify="center",anchor="center")
...
def De_Amt(accnt,name):
	...
	l_title=tk.Message(debitwn,text="Shivani ka Bank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="#C21807",justify="center",anchor="center")
	l_title.config(font=("Courier","30","bold"))
	l_title.pack(side="top")
...
def disp_bal(accnt):
	...
	l_title=tk.Message(disp,text="Shivani ka Bank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="#C21807",justify="center",anchor="center")
	l_title.config(font=("Courier","30","bold"))
	l_title.pack(side="top")
	fdet=open(accnt+".txt",'r')
	fdet.readline()
...
def disp_tr_hist(accnt):
    ...
    l_title=tk.Message(disp_wn,text="Shivani ka Bank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="#C21807",justify="center",anchor="center")
